...
import { PhoneCall, Radio, GraduationCap, UserCheck } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-slate-300 text-sm sm:text-base font-mono">
            "Have a question about the investigation? Contact the faculty or student coordinators."
          </p>
        </div>
        ...
        <div className="mb-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {EVENT_DATA.facultyContacts.map((contact, idx) => (
              <div
                key={contact.name}
                className="glass-panel-red rounded-2xl p-8 border border-red-900/40 hover:border-[#e31b23]/70 glass-panel-red-hover group flex flex-col justify-between"
              >
                <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 mb-6 justify-center">
            <UserCheck className="w-4 h-4 text-[#e31b23]" />
            <span className="font-mono text-xs text-slate-400 font-bold uppercase tracking-widest">
