...
export const EventTeam = () => {
  return (
    <section id="team" className="relative py-24 bg-[#030504] overflow-hidden border-t border-[#38E39A]/15">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
            <UserCheck className="w-3.5 h-3.5 text-[#B99A45]" />
            <span className="font-mono text-xs text-[#E1C66A] tracking-[0.25em]">ORGANIZERS & CONTACTS</span>
          </motion.div>
          ...
          >
            EVENT <span className="text-[#38E39A] font-mono">TEAM</span>
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-[#8E9A94] text-base max-w-md mt-3 font-normal"
          >
            Faculty coordinator and student event coordinators for Marvel Quiz at IGNITRRON'26.
          </motion.p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
          
          {/* Faculty Card (Left Column) */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="lg:col-span-4 glass-panel p-8 rounded-3xl border-[#B99A45]/40 bg-[#07100B]/90 shadow-gold-glow flex flex-col items-center text-center relative"
          >
          ...
          {/* Student Coordinators (Right Column - 3 Cards with 01, 02, 03 numbering) */}
              ...
              >
                <div className="flex flex-col items-center w-full">
                  <div className="flex items-center justify-between w-full mb-3">
                    <span className="font-mono text-xs font-extrabold text-[#B99A45]">
                      {c.id}
                    </span>
                    <span className="font-mono text-[9px] text-[#38E39A] tracking-widest font-bold uppercase">
                      STUDENT
                    </span>
                  </div>
