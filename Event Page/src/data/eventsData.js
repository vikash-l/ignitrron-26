...
export const TOTAL_PRIZE_POOL = 305000;
...
export const EVENTS_DATA = [
  ...
  {
    id: "05",
    title: "Bridge Construction Challenge",
  ...
  },
  {
    ...
    coordinators: [
      { name: "Dhivya Bharathi V", phone: "7810002013" },
      { name: "Thyanica V", phone: "9566759995" },
  ...
  },
  {
    ...
    description: "Inter-collegiate sports and physical engineering challenge tournament.",
    accentColor: "#00D9FF",
    position: [28, -2, -6]
  },
  {
  ...
  {
    id: "16",
    title: "24-Hour Industry Hackathon",
  ...
  {
    id: "20",
    title: "Ignitia – HR session",
    heroCharacter: "Happy Hogan",
    quote: "I drive the boss around and manage the floor.",
    ...
    prizes: { first: "Networking", second: "Certificates", third: "Mentorship", total: "Corporate Access" },
    description: "Exclusive corporate HR leadership panel and hiring guidance session.",
    accentColor: "#00D9FF",
    position: [6, -10, 16]
  },
  {
    ...
    description: "Ultimate trivia battle across Marvel Cinematic Universe and comic lore.",
    accentColor: "#00D9FF",
    position: [-6, 18, 8]
  },
  {
  ...
  },
  {
    ...
    quote: "Look into my eyes. Feel their pain.",
  ...
  },
  {
    ...
    quote: "Dance-off, bro. Me and you.",
...
EVENTS_DATA.forEach(evt => {
  if (!evt.url) {
    evt.url = evt.status === 'coming-soon' ? '/coming-soon/' : null;
  }
});
