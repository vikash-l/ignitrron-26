                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        onDoubleClick={() => onOpenEvent && onOpenEvent(item)}
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', flexShrink: 0 }}>
                          ...
                          {isActive ? (
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                if (onOpenEvent) onOpenEvent(item);
                              }}
                            ...
                            >
                              ...
                              <span>ENTER</span>
                              <ChevronRight size={10} color={item.isHeroEvent ? '#FFF' : '#020605'} />
                            </button>
                          ) : (
                            <span style={{
                              fontFamily: "'Share Tech Mono', monospace",
