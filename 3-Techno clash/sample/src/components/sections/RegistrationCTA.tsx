...
export const RegistrationCTA: React.FC<RegistrationCTAProps> = ({ onRegisterClick }) => {
  return (
    <section id="registration" className="py-24 relative overflow-hidden bg-slate-950">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[600px] h-[600px] bg-cyan-500/10 rounded-full filter blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
        ...
        <div className="relative bg-[#080d24]/90 border-2 border-cyan-400/70 rounded-3xl p-8 sm:p-14 shadow-[0_0_80px_rgba(0,240,255,0.3)] backdrop-blur-xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-40">
            <svg className="w-full max-w-[550px] h-[550px] animate-spin-slow" viewBox="0 0 500 500">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-600 hover:from-cyan-400 hover:to-violet-500 text-slate-950 font-mono font-black text-base shadow-[0_0_40px_rgba(0,240,255,0.5)] transition-all transform hover:scale-105 flex items-center justify-center gap-3 no-underline"
              >
