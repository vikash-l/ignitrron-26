...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 bg-[#04080F]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                {eventData.about.bullets.map((bullet, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <span className="flex-shrink-0 mt-1 h-5 w-5 rounded-full bg-emerald-500/10 border border-emerald-900/30 flex items-center justify-center text-emerald-500">
          ...
          {/* Dotted laboratory transformation visual placeholder */}
          <div className="lg:col-span-5 flex justify-center">
            ...
            >
              <div className="space-y-4">
                ...
                <span className="text-xs sm:text-sm font-mono tracking-widest text-emerald-500 uppercase block">
                  TRANSFORMATION CHAMBER
                </span>
                
                <div className="h-0.5 w-16 bg-emerald-800/40 mx-auto" />
                
                <p className="text-xs text-slate-500 leading-relaxed font-mono max-w-[280px] mx-auto">
                  // CONCEPT SCHEMA:<br />
                  BRUCE BANNER → SCIENTIFIC HERO<br />
                  PROPOSE • ANALYZE • DEFEND
                </p>
              </div>
            </motion.div>
          </div>
