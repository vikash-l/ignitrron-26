        ...
        return (
          ...
          >
            <button
              ...
              className="flex justify-between items-center w-full px-6 py-4 text-left text-white font-medium hover:text-emerald-400 transition-colors duration-200 cursor-pointer"
