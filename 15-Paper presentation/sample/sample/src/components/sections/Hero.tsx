        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <motion.div
              ...
              className="relative w-full max-w-[420px] aspect-square rounded-3xl border border-cyan-500/40 bg-slate-900/60 backdrop-blur-md p-3 text-center shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300 group"
            >
              <div className="relative w-full h-full rounded-2xl overflow-hidden">
                <img
                  src="assets/pym_scientist_lab.jpg"
                  alt="Dr. Hank Pym Quantum Laboratory"
                  className="w-full h-full object-cover rounded-2xl group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent opacity-60"></div>
                <div className="absolute bottom-4 left-4 right-4 text-left p-3 rounded-xl bg-slate-950/80 backdrop-blur-md border border-cyan-500/30">
