  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#1D4ED8]/20 via-[#DC2626]/10 to-[#1D4ED8]/25 blur-[120px]" />
        <div className="w-[850px] h-[850px] rounded-full border border-blue-500/10 animate-shield-spin-slow" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Cinematic Heading */}
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-black font-orbitron text-white tracking-tight leading-tight mb-16">
          ONE PLATFORM.{' '}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto text-left">
