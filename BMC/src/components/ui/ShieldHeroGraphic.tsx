...
export const ShieldHeroGraphic: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute w-80 h-80 sm:w-full max-w-[420px] sm:h-[420px] md:w-full max-w-[500px] md:h-[500px] rounded-full bg-gradient-to-tr from-[#1D4ED8]/30 via-[#DC2626]/20 to-[#1D4ED8]/35 blur-[80px] pointer-events-none animate-pulse" />

      <motion.div
        style={{ rotateX, rotateY, transformStyle: 'preserve-3d' }}
        className="relative w-full max-w-full max-w-[340px] sm:max-w-full max-w-[420px] md:max-w-full max-w-[480px] flex items-center justify-center"
      >
        {/* Outer S.H.I.E.L.D. Tactical HUD Ring Behind Character */}
        <div className="absolute w-[300px] h-[300px] sm:w-full max-w-[380px] sm:h-[380px] md:w-full max-w-[440px] md:h-[440px] rounded-full border border-blue-500/25 animate-shield-spin pointer-events-none">
        ...
        <div className="absolute w-[260px] h-[260px] sm:w-full max-w-[340px] sm:h-[340px] md:w-full max-w-[390px] md:h-[390px] rounded-full border border-blue-400/30 animate-shield-spin-reverse pointer-events-none">
        ...
        <div className="absolute w-[280px] h-[280px] sm:w-full max-w-[360px] sm:h-[360px] md:w-full max-w-[410px] md:h-[410px] rounded-full overflow-hidden pointer-events-none opacity-40">
          <div
