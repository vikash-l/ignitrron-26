  ...
  return (
    <section className="relative py-28 sm:py-36 overflow-hidden bg-gradient-to-b from-[#030712] via-[#0A2342]/70 to-[#030712]">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-full max-w-[650px] h-[650px] rounded-full bg-gradient-to-tr from-[#1D4ED8]/25 via-[#DC2626]/20 to-[#1D4ED8]/25 blur-[100px] animate-pulse" />
        <div className="w-full max-w-[500px] h-[500px] rounded-full border border-blue-400/15 animate-shield-spin" />
        <div className="w-full max-w-[700px] h-[700px] rounded-full border border-red-500/15 animate-shield-spin-reverse" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl sm:text-3xl sm:text-2xl sm:text-3xl md:text-4xl lg:text-5xl md:text-3xl sm:text-4xl md:text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:text-6xl lg:text-7xl md:text-4xl sm:text-3xl sm:text-4xl md:text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:text-6xl md:text-3xl sm:text-2xl sm:text-3xl md:text-4xl lg:text-5xl md:text-3xl sm:text-4xl md:text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:text-6xl lg:text-7xl lg:text-8xl font-black font-orbitron tracking-tight text-white">
