...
export const WhatOffers: React.FC = () => {
  ...
  return (
    <section id="offerings" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-full max-w-[700px] h-[350px] bg-[#1D4ED8]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 md:grid-cols-3 gap-8">
