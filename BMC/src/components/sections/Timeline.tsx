        ...
        >
          ...
          {eventData.timeline.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Timeline node dot */}
                <div className="absolute left-[calc(0px-9px)] md:left-1/2 top-7 h-4.5 w-4.5 rounded-full border-2 border-slate-950 bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.6)] md:-translate-x-[9px]" />
                ...
                <div className={`w-full md:w-[45%] p-6 rounded-xl border border-slate-900 bg-slate-900/30 hover:bg-slate-900/50 hover:border-slate-800 transition-all duration-300 ${
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    {item.day && (
                      <span className="inline-block px-2.5 py-0.5 rounded bg-blue-600/10 border border-blue-900/20 text-[10px] font-bold tracking-wider text-blue-500 uppercase">
                        {item.day}
                      </span>
                    )}
                    <span className="inline-flex items-center text-xs font-bold text-blue-500">
