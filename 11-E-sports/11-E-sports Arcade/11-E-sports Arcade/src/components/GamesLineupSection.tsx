...
const GamesLineupSection = () => {
  const games = [
    { title: 'EA FC 24', genre: 'Sports', image: 'eafc24.jpg' },
    { title: 'Tekken 8', genre: 'Fighting', image: 'Tekken8.jpg' },
    { title: 'Mortal Kombat 1', genre: 'Fighting', image: 'mortal_kombat_1.jpg' },
    { title: 'Spider-Man 2', genre: 'Action', image: 'spiderman.jpg' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {games.map((game, index) => (
            ...
            >
              <div className="h-56 sm:h-60 relative overflow-hidden rounded-t-3xl">
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0f14] via-transparent to-transparent z-10"></div>
                <img 
                  src={game.image} 
                  alt={game.title} 
                  className="w-full h-full object-cover opacity-100 transform group-hover:scale-105 transition-all duration-500"
                />
              </div>
