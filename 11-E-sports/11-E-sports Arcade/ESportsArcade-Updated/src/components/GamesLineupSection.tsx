...
const GamesLineupSection = () => {
  const games = [
    { title: 'EA FC 24', genre: 'Sports', image: `${import.meta.env.BASE_URL}eafc24.jpg` },
    { title: 'Tekken 8', genre: 'Fighting', image: `${import.meta.env.BASE_URL}Tekken8.jpg` },
    { title: 'Mortal Kombat 1', genre: 'Fighting', image: `${import.meta.env.BASE_URL}Mortal kombat 1.jpg` },
    { title: 'Spider-Man 2', genre: 'Action', image: `${import.meta.env.BASE_URL}spiderman.jpg` },
  ];
