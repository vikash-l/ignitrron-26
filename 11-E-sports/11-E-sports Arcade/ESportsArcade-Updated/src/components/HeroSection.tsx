        ...
        <div className="lg:w-1/2 text-left z-20 mt-12 lg:mt-0 relative">
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <a href="#games" className="btn-glow px-8 py-5 rounded-full text-white font-bold uppercase tracking-widest text-sm flex items-center gap-2 group">
        ...
        <div className="lg:w-1/2 w-full flex justify-center lg:justify-end mt-16 lg:mt-0 relative z-10 pointer-events-none">
           ...
           >
             ...
             <motion.img 
               ...
               src={`${import.meta.env.BASE_URL}baby_groot_ps4.png`}
